            ...
            if decoded_dict:
                ...
                for i, groundtruth_box in enumerate(groundtruth_boxes):
                    for j, detection_box in enumerate(detection_boxes):
                        ...
                        if iou >= IOU_THRESHOLD or iou < IOU_THRESHOLD  :
                ...
                all_groundtruth_classes.append(1) #siempre se llena el gt
                # all_detection_classes.append(matches[0][2])
                if matches.size == 0:
                    # print('salida:', 0)
                    all_detection_classes.append(0)
                elif matches.size != 0:
                    # print('salida:', 1)
                    all_detection_classes.append(matches[0][2])
                    # all_detection_classes.append(1)
...
#ROC and AUC curve metrics
    # fpr , tpr , thresholds = roc_curve ( all_groundtruth_classes , all_detection_classes)
    # plot_roc_curve (fpr,tpr) 
    # print('groundtruth_classes', len(all_groundtruth_classes))
    # print('detection_classes', len(all_detection_classes))
    # print('fpr', fpr)
    # print('tpr', tpr)
    np.savetxt("all_groundtruth_classes.txt", all_groundtruth_classes, fmt='%.2f')
    np.savetxt("all_detection_classes.txt", all_detection_classes, fmt='%.2f')
